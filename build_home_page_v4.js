...
export default function StudentDashboard() {
  ...
  // New Header for Home Page (White Background, Beautiful Proportions)
  const HomeHeader = () => (
    <div className="bg-white px-6 pt-5 pb-5 flex justify-between items-center z-50 relative rounded-b-[32px] shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
        <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center p-1.5 border border-slate-100 shadow-[inset_0_2px_5px_rgba(0,0,0,0.02)]">
  ...
  const LeftScreen = () => {
      // Home Work removed, leaving exactly 15 items for a perfect 5x3 grid
      const categories = [
      ...
      return (
         ...
         >
            ...
            <div className="relative z-20 bg-white rounded-t-[40px] px-5 pt-8 pb-4 shadow-[0_-15px_40px_rgba(0,0,0,0.08)] w-full mt-auto">
                ...
                {/* Footer Branding (mb-0 and pb-0 so no extra scroll space) */}
