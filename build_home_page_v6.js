...
export default function StudentDashboard() {
  ...
  const LeftScreen = () => {
      // Replaced old icons with much better, modern Lucide icons
      const categories = [
      ...
      return (
         ...
         >
            ...
            <div className="relative z-20 bg-white rounded-t-[40px] px-5 pt-8 pb-4 shadow-[0_-15px_40px_rgba(0,0,0,0.08)] w-full mt-auto">
                ...
                {/* School Category Grid (Exactly 15 items: 3 rows of 5) */}
                ...
                <div className="mt-4 border-t border-slate-100 pt-8">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-base font-black text-slate-800">Class Leaderboard</h3>
                        </div>
                        <span className="text-[10px] font-bold text-blue-500 cursor-pointer" onClick={() => setActiveTab('leaderboard')}>Open Gamification</span>
                    </div>
                    ...
                    <button onClick={() => setActiveTab('leaderboard')} className="w-full py-4 mt-3 bg-slate-50 text-xs font-black text-slate-500 hover:bg-[#FFF9E6] hover:text-amber-600 hover:border-[#FFD166]/50 rounded-[20px] transition-all border border-slate-100 shadow-sm flex items-center justify-center gap-2">
                        View Complete Leaderboard <ChevronRight size={14} />
                    </button>
                </div>
  ...
  const RightScreen = () => {
    const renderContent = () => {
        // GAMIFICATION & LEADERBOARD SYSTEM (EXPERT PLAN)
        if (activeTab === "leaderboard") {
            return (
                <div className="flex flex-col mt-4 pb-10">
                    ...
                    <div className="flex gap-2 overflow-x-auto custom-scrollbar pb-2 mb-6 -mx-6 px-6">
                    ...
                    <div className="flex gap-3 overflow-x-auto custom-scrollbar pb-6 -mx-6 px-6 mb-4">
        ...
        // Keep other activeTabs as before
        if (activeTab === "diary") {
            return (
                ...
                <div className="flex justify-between items-end mb-6">
                    <div className="flex flex-col">
                        <h1 className="text-3xl font-black text-slate-800 capitalize tracking-tight">
                            {activeTab === 'diary' ? 'Discover' : activeTab === 'performance' ? 'Exams' : activeTab === 'leaderboard' ? 'Gamification' : activeTab}
                        </h1>
